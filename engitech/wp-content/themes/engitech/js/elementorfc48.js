    ...
    var testimonialSlider = function () {
        $('.ot-testimonials-slider').each( function () {
            ...
            $selector.not( '.slick-initialized' ).slick({
                ...
                fade: $fade,
                rtl: rtl_slick(),
                prevArrow: '<button type="button" class="prev-nav" aria-label="Previous testimonial"><i class="flaticon-back"></i></button>',
                nextArrow: '<button type="button" class="next-nav" aria-label="Next testimonial"><i class="flaticon-right-arrow-1"></i></button>',
                responsive: [
                    {
                        breakpoint: 1229,
                        settings: {
